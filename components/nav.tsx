...
import {
  ...
  Package, TrendingUp, Briefcase, Globe, Lightbulb, KeyRound, BellRing, ListTodo,
} from "lucide-react";
...
const ICONS: Record<string, any> = {
  LayoutDashboard, Receipt, Wallet, Tags, PiggyBank, CreditCard, Calculator, Settings, BookOpenCheck, Palette, Sparkles, Rocket, Target, CalendarDays, Building2, Package, TrendingUp, Briefcase, Globe, Lightbulb, KeyRound, BellRing, ListTodo,
};
...
function buildNav(tipo: "empresarial" | "personal"): NavEntry[] {
  ...
  const operacion: NavGroup = {
    ...
    items: [
      ...
      { href: "tareas",     label: "Tareas del equipo",  icon: "ListTodo" },
