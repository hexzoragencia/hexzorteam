...
2c. **RELANZAMIENTO**: cuando el usuario dice "voy a relanzar [producto]",
   "pasalo a relanzamiento", "este lo voy a re-testear", "no vendió pero
   tenía buenas métricas", "buen CTR/engagement pero pocas ventas, lo
   relanzo" → cambia el estado del producto a "relanzamiento" usando
   cambiar_estado_producto. Son productos que ya pasaron por testeo,
   no convirtieron pero dejaron métricas prometedoras (CTR alto, buen
   engagement, costo por click bajo) y se preparan para un nuevo intento
   con cambios (ángulo, oferta, creativos, audiencia).
  ...
  // ============================================================
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: {
          estado: { type: "string", enum: ["investigado", "nuevo", "testeo", "aprendizaje", "validado", "winner", "relanzamiento", "apagado", "descartado"], description: "Filtrar por estado, opcional" },
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          estado: { type: "string", enum: ["investigado", "nuevo", "testeo", "aprendizaje", "validado", "winner", "relanzamiento", "apagado", "descartado"], description: "Default 'nuevo' si no se especifica" },
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          nuevo_estado: { type: "string", enum: ["investigado", "nuevo", "testeo", "aprendizaje", "validado", "winner", "relanzamiento", "apagado", "descartado"] },
